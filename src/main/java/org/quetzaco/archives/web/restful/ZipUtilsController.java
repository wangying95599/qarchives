...
public class ZipUtilsController {
    ...
    public void doCompress(Map itemMap, String zipFile) throws IOException, DocumentException {
        doCompress(itemMap, new File(zipFile));
    }


    private void doCompress(Map itemMap, File zipFile) throws IOException, DocumentException {
    ...
    private void doCompress(Map itemMap, ZipOutputStream out) throws IOException, DocumentException {
        doCompress(itemMap, out, "");
    }


    private void doCompress(Map itemMap, ZipOutputStream out, String dir) throws IOException, DocumentException {
    ...
    private void doZip(File inFile, String fileName, ZipOutputStream out, String dir) throws IOException, DocumentException {
        ...
        if (inFile != null) {
            ...
            if(!new File(waterMarkPath).exists()){
                LOGGER.debug("压缩 pdf 加水印中。。。"+waterMarkPath);
                if(new File(pdfPath).exists()){
                    ...
                    LOGGER.debug("压缩 PDF 加水印结束。。。"+waterMarkPath);
                }
            }
            ...
            try {
                ...
                FileInputStream fis = new FileInputStream(waterMarkFile);
    ...
    private List<Map> getChilds(Object id, String reelType) {
        ...
        switch (reelType) {
            ...
            case "archive":
                ...
                break;
            case "record":
                list3 = documentMapper.selectFromRecord((Long) id, null,false,null);
