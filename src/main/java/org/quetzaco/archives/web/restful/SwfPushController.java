...
public class SwfPushController {
    ...
    public ResponseEntity<Resource> swfPush(@PathVariable("fileId") String fileId,
    ...
    private FileInputStream getFile(String fileId, String strCurPageNum) throws FileNotFoundException {
