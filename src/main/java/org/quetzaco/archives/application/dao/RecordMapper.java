...
public interface RecordMapper {
    ...
    List<Record> searchRecordListByIds(@Param("flowId")Long flowId);
    
    List<Record> selectRooms(Record record);

    List<String> getSubFidByRecIds(@Param("recIds") List<Long> recIds);
}